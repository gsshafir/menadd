---
title: "Which Entity a Round Actually Closes Into"
...
What it does not do is remove execution risk. The rights still have to be built: articles that permit what the shareholders agreement promises, allotment authority, pre-emption waived or disapplied, the right board and shareholder approvals, a register updated when anything moves. The framework makes the mechanics available. Somebody still has to run them.
