---
title: "The UAE Raise Is a Trust Process"
...
And use the period to fix what diligence will find. This is dead time only if you waste it. The structural questions that stall a round are known in advance and take months to correct, which is why the [entity your round will close into](/library/structure/operational-is-not-investable/) should be settled before the conversation gets serious rather than after.
